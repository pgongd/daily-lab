  ...
  return (
    <header className="header">
      <div className="header__inner">
        <div className="header__special-bg"></div>
        <div className="header__top">
          <div className="header__left">
            <div className="top-menu">
              <button className="top-menu__btn" type="button" aria-haspopup="menu" aria-expanded={isMenuOpen} onClick={() => setIsMenuOpen((prev) => !prev)}>
          ...
          <div className={style['inner']}>
            <h1 className="logo">
              <a href="#" className="logo__link">
                <svg className="sv-logo" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
            ...
            <form className={style['form']} aria-label="사이트 검색">
              <div className={style['field']}>
                ...
                <input id="search-input" type="search" className={style['input']} placeholder="검색어를 입력하세요" autoComplete="off" />
                <button type="submit" className={style['submit']} aria-label="검색">
                  <svg viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg" className="sv_search" aria-hidden="true" focusable="false" fill="currentColor">
            ...
            {serviceIcon.map((item) => (
              <li key={item.type} className={style['item']}>
                <a href="#" className={style['link']}>
                  <span className={`${style['service-icon']} ${style[item.type]}`} aria-hidden="true" />
        ...
        <div className="headline">
          <a href="#" className="headline__link" target="_blank" rel="noopener noreferrer">
            <img src="https://ssl.pstatic.net/melona/libs/1567/1567860/f789528a2181521bac21_20260430185253808_5.png" width="244" height="108" alt="라이온코리아 광고" />
          </a>
        </div>
      </div>
    </header>
