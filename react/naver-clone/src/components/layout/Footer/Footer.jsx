  ...
  return (
    <footer className="footer">
      <div className="footer__inner">
        <div className="footer__nbanner">배너영역</div>
        <div className="footer__notice">공지영역</div>
          ...
          <div className="service-wrap">
            <div className="service-box">
              ...
              <div className="service-info">
                <strong className="tit">웨일 브라우저</strong>
                <a target="_blank" href="#" className="desc">
                  이용안내
                </a>
              </div>
            </div>
        ...
        <div className="footer__corp"></div>
      </div>
    </footer>
  );
}
